...
def main():
    ...
    model = DRGR(user_count+1, item_count+1, rate_count+1, args.embed_dim).to(device)
    ...
    scheduler = StepLR(optimizer, step_size=args.lr_dc_step, gamma=args.lr_dc)  # 调整学习率，step_size个回合后，调整学习率为lr*gamma
    sum_dv_list = []
    pre_sum = 0
